...
(cl:defmethod cl:initialize-instance :after ((m <Joystick>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joystick)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name teleop-msg:<Joystick> is deprecated: use teleop-msg:Joystick instead.")))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <Joystick>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teleop-msg:time-val is deprecated.  Use teleop-msg:time instead.")
  (time m))

(cl:ensure-generic-function 'event-val :lambda-list '(m))
(cl:defmethod event-val ((m <Joystick>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teleop-msg:event-val is deprecated.  Use teleop-msg:event instead.")
  (event m))
