...
(cl:defmethod cl:initialize-instance :after ((m <Joystick>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joystick)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name teleop_msgs-msg:<Joystick> is deprecated: use teleop_msgs-msg:Joystick instead.")))
