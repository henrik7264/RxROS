...
(cl:defmethod cl:initialize-instance :after ((m <Range>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Range)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name brickpi3_ros-msg:<Range> is deprecated: use brickpi3_ros-msg:Range instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader brickpi3_ros-msg:header-val is deprecated.  Use brickpi3_ros-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'range-val :lambda-list '(m))
(cl:defmethod range-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader brickpi3_ros-msg:range-val is deprecated.  Use brickpi3_ros-msg:range instead.")
  (range m))

(cl:ensure-generic-function 'range_min-val :lambda-list '(m))
(cl:defmethod range_min-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader brickpi3_ros-msg:range_min-val is deprecated.  Use brickpi3_ros-msg:range_min instead.")
  (range_min m))

(cl:ensure-generic-function 'range_max-val :lambda-list '(m))
(cl:defmethod range_max-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader brickpi3_ros-msg:range_max-val is deprecated.  Use brickpi3_ros-msg:range_max instead.")
  (range_max m))

(cl:ensure-generic-function 'spread_angle-val :lambda-list '(m))
(cl:defmethod spread_angle-val ((m <Range>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader brickpi3_ros-msg:spread_angle-val is deprecated.  Use brickpi3_ros-msg:spread_angle instead.")
  (spread_angle m))
