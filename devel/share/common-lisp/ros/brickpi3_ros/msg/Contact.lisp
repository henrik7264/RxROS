...
(cl:defmethod cl:initialize-instance :after ((m <Contact>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Contact)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name brickpi3_ros-msg:<Contact> is deprecated: use brickpi3_ros-msg:Contact instead.")))
...
(cl:defmethod contact-val ((m <Contact>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader brickpi3_ros-msg:contact-val is deprecated.  Use brickpi3_ros-msg:contact instead.")
  (contact m))
