...
(cl:defmethod cl:initialize-instance :after ((m <JointCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name brickpi3_msgs-msg:<JointCommand> is deprecated: use brickpi3_msgs-msg:JointCommand instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <JointCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader brickpi3_msgs-msg:name-val is deprecated.  Use brickpi3_msgs-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'effort-val :lambda-list '(m))
(cl:defmethod effort-val ((m <JointCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader brickpi3_msgs-msg:effort-val is deprecated.  Use brickpi3_msgs-msg:effort instead.")
  (effort m))
